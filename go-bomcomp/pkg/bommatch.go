// bommatch.go [2012-04-12 BAR8TL]
// Definition local variables and local functions for BOM list preparation and
// BOM matching in comparison process
package bomcomp
...
type sExplN struct{
  bomid, systm, werks, matnr, maktx sql.NullString
  stlal, mtart, beskz, sobsl, wtbom sql.NullString
}

type sList  struct{
  bomid, systm, werks, matnr, maktx string
  stlal, mtart, beskz, sobsl, wtbom string
  matnb string
}

func PrepMatchList(src string) {
  fmt.Print("Determining BOMs for comparison")
  RESET_TICKS()
  if src == "auto" {
    prepList("1")
    prepList("2")
...
func prepList(i string) {
  ...
  for ds.Next() {
    ...
    l := new(sList)
    err = ds.Scan(
      &e.bomid, &e.systm, &e.werks, &e.matnr, &e.maktx,
      &e.stlal, &e.mtart, &e.beskz, &e.sobsl, &e.wtbom)
    if err != nil {
    ...
    _, err = db.Exec(Q.Cmd["isrBomList"+i], l.bomid,
      l.systm, l.werks, l.matnr, l.maktx, l.stlal,
      l.mtart, l.beskz, l.sobsl, l.wtbom, l.matnb)
    if err != nil {
...
// Match list reader
type sBomidN struct {
  Systm, Werks, Matnr, Maktx sql.NullString
  Stlal, Mtart, Beskz, Sobsl sql.NullString
  Wtbom sql.NullString
}
...
func (m *SMtchN) ScanBomMtch(ds *sql.Rows) {
  err := ds.Scan(&m.Matnb, &m.Stlab, &m.Idenb,
    &m.P1.Systm, &m.P1.Werks, &m.P1.Matnr, &m.P1.Maktx, &m.P1.Stlal,
    &m.P1.Mtart, &m.P1.Beskz, &m.P1.Sobsl, &m.P1.Wtbom,
    &m.P2.Systm, &m.P2.Werks, &m.P2.Matnr, &m.P2.Maktx, &m.P2.Stlal,
    &m.P2.Mtart, &m.P2.Beskz, &m.P2.Sobsl, &m.P2.Wtbom)
  if err != nil {
...
type sBomid struct {
  Systm, Werks, Matnr, Maktx string
  Stlal, Mtart, Beskz, Sobsl string
  Wtbom string
}

type SCmpHdr struct {
  Seqnh, Items, Commo, Exclu, Commp int
  Comeq, Comdf, Comep, Tfldd, Mrate int
  Matnb, Stlab, Idenb, Gbcod, Bucod, Bomdf string
  P1, P2 sBomid
}

func (h *SCmpHdr) Clear() {
  h.Items, h.Commo, h.Exclu, h.Commp = 0, 0, 0, 0
  h.Comeq, h.Comdf, h.Comep, h.Tfldd = 0, 0, 0, 0
  h.Mrate = 0
  h.Matnb, h.Stlab, h.Idenb, h.Gbcod = "", "", "", ""
  h.Bucod, h.Bomdf = "", ""
  h.P1.Systm, h.P1.Werks, h.P1.Matnr, h.P1.Maktx = "", "", "", ""
  h.P1.Stlal, h.P1.Mtart, h.P1.Beskz, h.P1.Sobsl = "", "", "", ""
  h.P1.Wtbom = ""
  h.P2.Systm, h.P2.Werks, h.P2.Matnr, h.P2.Maktx = "", "", "", ""
  h.P2.Stlal, h.P2.Mtart, h.P2.Beskz, h.P2.Sobsl = "", "", "", ""
  h.P2.Wtbom = ""
}
...
func (h *SCmpHdr) IsrtCmpHdr(db *sql.DB) {
  _, err := db.Exec(Q.Cmd["isrBomHdrComp"], strconv.Itoa(h.Seqnh),
    S.Gbcod, S.Bucod, h.Idenb,
    h.P1.Systm, h.P1.Matnr, h.P1.Maktx, h.P1.Werks, h.P1.Stlal, h.P1.Mtart,
    h.P1.Beskz, h.P1.Sobsl, h.P1.Wtbom,
    h.P2.Systm, h.P2.Matnr, h.P2.Maktx, h.P2.Werks, h.P2.Stlal, h.P2.Mtart,
    h.P2.Beskz, h.P2.Sobsl, h.P2.Wtbom,
    h.Bomdf,
    strconv.Itoa(h.Items), strconv.Itoa(h.Commo), strconv.Itoa(h.Exclu),
    strconv.Itoa(h.Commp), strconv.Itoa(h.Comeq), strconv.Itoa(h.Comdf),
    strconv.Itoa(h.Comep), strconv.Itoa(h.Tfldd), strconv.Itoa(h.Mrate))
  if err != nil {
