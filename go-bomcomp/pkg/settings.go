// settings.go [2012-04-12 BAR8TL]
// Read program settings for BOM comparison and read of command line parameters
package bomcomp
...
func (s *Settings) NewSettings(fname string) {
  ...
  pstep := flag.String("steps", s.Dstep,
    "Processing steps: [LMC|other combination]. L=Local copy XLS files, " +
    "M=Match list prep, C=Compare BOMs")
  flag.Parse()
  s.Pstep = *pstep
}
