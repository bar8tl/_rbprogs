// bitmlocal.go [2012-04-12 BAR8TL]
// Definition of local variables and local functions for BOM copy, BOM Reader,
// BOM comparison mapping and writer
package bomcomp
...
func LocalCopyBomItm() {
  fmt.Print("Start local copy of BOM files to compare")
  RESET_TICKS()
  copyBomItm("1")
  copyBomItm("2")
  fmt.Println("")
...
func ReseqBomItems(db *sql.DB) {
  fmt.Print("Preparing comparison report")
  RESET_TICKS()
...
type SExplN struct {
  Systm, Werks, Matnr, Maktx, Stlal, Mtart, Beskz, Sobsl, Posnr sql.NullString
  Postp, Idnrk, Cmakt, Cmtar, Cbesk, Csobs, Meins, Alpos, Alpgr sql.NullString
  Alprf, Alpst, Sanko, Sanfe, Sanka, Dokar, Doknr, Dokvr, Doktl sql.NullString
...
func (d *SExplN) ScanExpl(ds *sql.Rows) {
  err := ds.Scan(
    &d.Systm, &d.Werks, &d.Matnr, &d.Maktx, &d.Stlal, &d.Mtart, &d.Beskz,
    &d.Sobsl, &d.Posnr, &d.Postp, &d.Idnrk, &d.Cmakt, &d.Cmtar, &d.Cbesk,
    &d.Csobs, &d.Menge, &d.Meins, &d.Alpos, &d.Alpgr, &d.Alprf, &d.Alpst,
    &d.Ewahr, &d.Sanko, &d.Sanfe, &d.Sanka, &d.Dokar, &d.Doknr, &d.Dokvr,
    &d.Doktl, &d.Match, &d.Exstr)
  if err != nil {
...
//
type SExpl struct {
  Systm, Werks, Matnr, Maktx, Stlal, Mtart, Beskz, Sobsl, Posnr string
  Postp, Idnrk, Cmakt, Cmtar, Cbesk, Csobs, Meins, Alpos, Alpgr string
  Alprf, Alpst, Sanko, Sanfe, Sanka, Dokar, Doknr, Dokvr, Doktl string
  Menge, Ewahr float64
...
func (e *SExpl) Clear() {
  e.Systm, e.Werks, e.Matnr, e.Maktx, e.Stlal = "", "", "", "", ""
  e.Mtart, e.Beskz, e.Sobsl, e.Posnr, e.Postp = "", "", "", "", ""
  e.Idnrk, e.Cmakt, e.Cmtar, e.Cbesk, e.Csobs = "", "", "", "", ""
  e.Meins, e.Alpos, e.Alpgr, e.Alprf, e.Alpst = "", "", "", "", ""
  e.Sanko, e.Sanfe, e.Sanka, e.Dokar, e.Doknr = "", "", "", "", ""
  e.Dokvr, e.Doktl = "", ""
  e.Menge, e.Ewahr = 0, 0
}
...
type SItmdt struct {
  ...
  Menge, Ewahr float64
  Match, Exstr string
  Posnrd, Postpd, Idnrkd, Cmaktd, Cmtard, Cbeskd, Csobsd, Meinsd string
  Alposd, Alpgrd, Alprfd, Alpstd, Sankod, Sanfed, Sankad, Dokard string
  Doknrd, Dokvrd, Doktld string
  Menged, Ewahrd string
}

type SWrkItm struct {
  Seqnw, Seqni, Ifldd, Nline int
  Ident, Ibom1, Ibom2, Itmdf string
  Posnr string
  P1, P2 SItmdt
}

func (w *SWrkItm) HideItemBom1() *SWrkItm {
  w.P1.Maktx, w.P1.Mtart, w.P1.Beskz, w.P1.Sobsl = "", "", "", ""
  w.P1.Posnr, w.P1.Postp, w.P1.Idnrk, w.P1.Cmakt = "", "", "", ""
  w.P1.Cmtar, w.P1.Cbesk, w.P1.Csobs, w.P1.Meins = "", "", "", ""
  w.P1.Alpos, w.P1.Alpgr, w.P1.Alprf, w.P1.Alpst = "", "", "", ""
  w.P1.Sanko, w.P1.Sanfe, w.P1.Sanka, w.P1.Dokar = "", "", "", ""
  w.P1.Doknr, w.P1.Dokvr, w.P1.Doktl = "", "", ""
  w.P1.Menge, w.P1.Ewahr = 0, 0
  return w
}

func (w *SWrkItm) HideItemBom2() *SWrkItm {
  w.P2.Maktx, w.P2.Mtart, w.P2.Beskz, w.P2.Sobsl = "", "", "", ""
  w.P2.Posnr, w.P2.Postp, w.P2.Idnrk, w.P2.Cmakt = "", "", "", ""
  w.P2.Cmtar, w.P2.Cbesk, w.P2.Csobs, w.P2.Meins = "", "", "", ""
  w.P2.Alpos, w.P2.Alpgr, w.P2.Alprf, w.P2.Alpst = "", "", "", ""
  w.P2.Sanko, w.P2.Sanfe, w.P2.Sanka, w.P2.Dokar = "", "", "", ""
  w.P2.Doknr, w.P2.Dokvr, w.P2.Doktl = "", "", ""
...
func (w *SWrkItm) ClearMarksItemBom1() *SWrkItm {
  w.P1.Posnrd, w.P1.Postpd, w.P1.Idnrkd, w.P1.Cmaktd = "", "", "", ""
  w.P1.Cmtard, w.P1.Cbeskd, w.P1.Csobsd, w.P1.Menged = "", "", "", ""
  w.P1.Meinsd, w.P1.Alposd, w.P1.Alpgrd, w.P1.Alprfd = "", "", "", ""
  w.P1.Alpstd, w.P1.Ewahrd, w.P1.Sankod, w.P1.Sanfed = "", "", "", ""
  w.P1.Sankad, w.P1.Dokard, w.P1.Doknrd, w.P1.Dokvrd = "", "", "", ""
  w.P1.Doktld = ""
  return w
}

func (w *SWrkItm) ClearMarksItemBom2() *SWrkItm {
  w.P2.Posnrd, w.P2.Postpd, w.P2.Idnrkd, w.P2.Cmaktd = "", "", "", ""
  w.P2.Cmtard, w.P2.Cbeskd, w.P2.Csobsd, w.P2.Menged = "", "", "", ""
  w.P2.Meinsd, w.P2.Alposd, w.P2.Alpgrd, w.P2.Alprfd = "", "", "", ""
  w.P2.Alpstd, w.P2.Ewahrd, w.P2.Sankod, w.P2.Sanfed = "", "", "", ""
  w.P2.Sankad, w.P2.Dokard, w.P2.Doknrd, w.P2.Dokvrd = "", "", "", ""
  w.P2.Doktld = ""
  return w
}
...
func (w *SWrkItm) IsrtWrkItm(db *sql.DB, h SCmpHdr) {
  ...
  _, err := db.Exec(Q.Cmd["isrBomItmWork"], sSeqnw, S.Gbcod, S.Bucod, w.Ident,
    w.Ibom1, w.Ibom2, sIfldd, w.Itmdf, sItems,
    w.P1.Systm,  w.P1.Matnr, w.P1.Maktx,  w.P1.Werks, w.P1.Stlal,  w.P1.Mtart,
    w.P1.Beskz,  w.P1.Sobsl, w.P1.Posnrd, w.P1.Posnr,
    w.P1.Postpd, w.P1.Postp, w.P1.Idnrkd, w.P1.Idnrk, w.P1.Cmaktd, w.P1.Cmakt,
    w.P1.Cmtard, w.P1.Cmtar, w.P1.Cbeskd, w.P1.Cbesk, w.P1.Csobsd, w.P1.Csobs,
    w.P1.Menged, smeng1,     w.P1.Meinsd, w.P1.Meins, w.P1.Alposd, w.P1.Alpos,
    w.P1.Alpgrd, w.P1.Alpgr, w.P1.Alprfd, w.P1.Alprf, w.P1.Alpstd, w.P1.Alpst,
    w.P1.Ewahrd, sewah1,     w.P1.Sankod, w.P1.Sanko, w.P1.Sanfed, w.P1.Sanfe,
    w.P1.Sankad, w.P1.Sanka, w.P1.Dokard, w.P1.Dokar, w.P1.Doknrd, w.P1.Doknr,
    w.P1.Dokvrd, w.P1.Dokvr, w.P1.Doktld, w.P1.Doktl,
    w.P2.Systm,  w.P2.Matnr, w.P2.Maktx,  w.P2.Werks, w.P2.Stlal,  w.P2.Mtart,
    w.P2.Beskz,  w.P2.Sobsl, w.P2.Posnrd, w.P2.Posnr,
    w.P2.Postpd, w.P2.Postp, w.P2.Idnrkd, w.P2.Idnrk, w.P2.Cmaktd, w.P2.Cmakt,
    w.P2.Cmtard, w.P2.Cmtar, w.P2.Cbeskd, w.P2.Cbesk, w.P2.Csobsd, w.P2.Csobs,
    w.P2.Menged, smeng2,     w.P2.Meinsd, w.P2.Meins, w.P2.Alposd, w.P2.Alpos,
    w.P2.Alpgrd, w.P2.Alpgr, w.P2.Alprfd, w.P2.Alprf, w.P2.Alpstd, w.P2.Alpst,
    w.P2.Ewahrd, sewah2,     w.P2.Sankod, w.P2.Sanko, w.P2.Sanfed, w.P2.Sanfe,
    w.P2.Sankad, w.P2.Sanka, w.P2.Dokard, w.P2.Dokar, w.P2.Doknrd, w.P2.Doknr,
    w.P2.Dokvrd, w.P2.Dokvr, w.P2.Doktld, w.P2.Doktl,
    sSeqnh, w.Posnr)
  if err != nil {
...
type SItmdtN struct {
  ...
  Posnr, Postp, Idnrk, Cmakt, Cmtar, Cbesk, Csobs, Meins sql.NullString
  Alpos, Alpgr, Alprf, Alpst, Sanko, Sanfe, Sanka, Dokar sql.NullString
  Doknr, Dokvr, Doktl sql.NullString
  Menge, Ewahr sql.NullFloat64
  Posnrd, Postpd, Idnrkd, Cmaktd, Cmtard, Cbeskd, Csobsd sql.NullString
  Meinsd, Alposd, Alpgrd, Alprfd, Alpstd, Sankod, Sanfed sql.NullString
  Sankad, Dokard, Doknrd, Dokvrd, Doktld sql.NullString
...
func (j *SWrkItmN) ScanWrkItm(ds *sql.Rows) {
  err := ds.Scan(&j.Seqnw, &j.Gbcod, &j.Bucod, &j.Ident,
    &j.Ibom1, &j.Ibom2, &j.Ifldd, &j.Itmdf, &j.Items,
    &j.P1.Systm,  &j.P1.Matnr, &j.P1.Maktx,  &j.P1.Werks,
    &j.P1.Stlal,  &j.P1.Mtart, &j.P1.Beskz,  &j.P1.Sobsl,
    &j.P1.Posnrd, &j.P1.Posnr, &j.P1.Postpd, &j.P1.Postp,
    &j.P1.Idnrkd, &j.P1.Idnrk, &j.P1.Cmaktd, &j.P1.Cmakt,
    &j.P1.Cmtard, &j.P1.Cmtar, &j.P1.Cbeskd, &j.P1.Cbesk,
    &j.P1.Csobsd, &j.P1.Csobs, &j.P1.Menged, &j.P1.Menge,
    &j.P1.Meinsd, &j.P1.Meins, &j.P1.Alposd, &j.P1.Alpos,
    &j.P1.Alpgrd, &j.P1.Alpgr, &j.P1.Alprfd, &j.P1.Alprf,
    &j.P1.Alpstd, &j.P1.Alpst, &j.P1.Ewahrd, &j.P1.Ewahr,
    &j.P1.Sankod, &j.P1.Sanko, &j.P1.Sanfed, &j.P1.Sanfe,
    &j.P1.Sankad, &j.P1.Sanka, &j.P1.Dokard, &j.P1.Dokar,
    &j.P1.Doknrd, &j.P1.Doknr, &j.P1.Dokvrd, &j.P1.Dokvr,
    &j.P1.Doktld, &j.P1.Doktl,
    &j.P2.Systm,  &j.P2.Matnr, &j.P2.Maktx,  &j.P2.Werks,
    &j.P2.Stlal,  &j.P2.Mtart, &j.P2.Beskz,  &j.P2.Sobsl,
    &j.P2.Posnrd, &j.P2.Posnr, &j.P2.Postpd, &j.P2.Postp,
    &j.P2.Idnrkd, &j.P2.Idnrk, &j.P2.Cmaktd, &j.P2.Cmakt,
    &j.P2.Cmtard, &j.P2.Cmtar, &j.P2.Cbeskd, &j.P2.Cbesk,
    &j.P2.Csobsd, &j.P2.Csobs, &j.P2.Menged, &j.P2.Menge,
    &j.P2.Meinsd, &j.P2.Meins, &j.P2.Alposd, &j.P2.Alpos,
    &j.P2.Alpgrd, &j.P2.Alpgr, &j.P2.Alprfd, &j.P2.Alprf,
    &j.P2.Alpstd, &j.P2.Alpst, &j.P2.Ewahrd, &j.P2.Ewahr,
    &j.P2.Sankod, &j.P2.Sanko, &j.P2.Sanfed, &j.P2.Sanfe,
    &j.P2.Sankad, &j.P2.Sanka, &j.P2.Dokard, &j.P2.Dokar,
    &j.P2.Doknrd, &j.P2.Doknr, &j.P2.Dokvrd, &j.P2.Dokvr,
...
type SCmpdt struct {
  ...
  Posnrd, Postpd, Idnrkd, Cmaktd, Cmtard, Cbeskd, Csobsd, Meinsd string
  Alposd, Alpgrd, Alprfd, Alpstd, Sankod, Sanfed, Sankad, Dokard string
  Doknrd, Dokvrd, Doktld, Menged, Ewahrd string
}
...
func (i *SCmpItm) Clear() {
  ...
  i.Gbcod, i.Bucod, i.Ident = "", "", ""
  i.Ibom1, i.Ibom2, i.Itmdf, i.Posnr = "", "", "", ""
  i.P1.Systm, i.P1.Werks, i.P1.Matnr, i.P1.Maktx = "", "", "", ""
  i.P1.Stlal, i.P1.Mtart, i.P1.Beskz, i.P1.Sobsl = "", "", "", ""
  i.P1.Posnr, i.P1.Postp, i.P1.Idnrk, i.P1.Cmakt = "", "", "", ""
  i.P1.Cmtar, i.P1.Cbesk, i.P1.Csobs, i.P1.Meins = "", "", "", ""
  i.P1.Alpos, i.P1.Alpgr, i.P1.Alprf, i.P1.Alpst = "", "", "", ""
  i.P1.Sanko, i.P1.Sanfe, i.P1.Sanka, i.P1.Dokar = "", "", "", ""
  i.P1.Doknr, i.P1.Dokvr, i.P1.Doktl = "", "", ""
  i.P1.Menge, i.P1.Ewahr = 0, 0
  i.P1.Posnrd, i.P1.Postpd, i.P1.Idnrkd, i.P1.Cmaktd = "", "", "", ""
  i.P1.Cmtard, i.P1.Cbeskd, i.P1.Csobsd, i.P1.Meinsd = "", "", "", ""
  i.P1.Alposd, i.P1.Alpgrd, i.P1.Alprfd, i.P1.Alpstd = "", "", "", ""
  i.P1.Sankod, i.P1.Sanfed, i.P1.Sankad, i.P1.Dokard = "", "", "", ""
  i.P1.Doknrd, i.P1.Dokvrd, i.P1.Doktld = "", "", ""
  i.P1.Menged, i.P1.Ewahrd = "", ""
  i.P2.Systm, i.P2.Werks, i.P2.Matnr, i.P2.Maktx = "", "", "", ""
  i.P2.Stlal, i.P2.Mtart, i.P2.Beskz, i.P2.Sobsl = "", "", "", ""
  i.P2.Posnr, i.P2.Postp, i.P2.Idnrk, i.P2.Cmakt = "", "", "", ""
  i.P2.Cmtar, i.P2.Cbesk, i.P2.Csobs, i.P2.Meins = "", "", "", ""
  i.P2.Alpos, i.P2.Alpgr, i.P2.Alprf, i.P2.Alpst = "", "", "", ""
  i.P2.Sanko, i.P2.Sanfe, i.P2.Sanka, i.P2.Dokar = "", "", "", ""
  i.P2.Doknr, i.P2.Dokvr, i.P2.Doktl = "", "", ""
  i.P2.Menge, i.P2.Ewahr = 0, 0
  i.P2.Posnrd, i.P2.Postpd, i.P2.Idnrkd, i.P2.Cmaktd = "", "", "", ""
  i.P2.Cmtard, i.P2.Cbeskd, i.P2.Csobsd, i.P2.Meinsd = "", "", "", ""
  i.P2.Alposd, i.P2.Alpgrd, i.P2.Alprfd, i.P2.Alpstd = "", "", "", ""
  i.P2.Sankod, i.P2.Sanfed, i.P2.Sankad, i.P2.Dokard = "", "", "", ""
  i.P2.Doknrd, i.P2.Dokvrd, i.P2.Doktld = "", "", ""
...
func (i *SCmpItm) IsrtCmpItm(db *sql.DB) {
  ...
  _, err := db.Exec(Q.Cmd["isrBomItmComp"], sSeqni,
    i.Gbcod, i.Bucod, i.Ident, i.Ibom1, i.Ibom2, sIfldd, i.Itmdf, sNline,
    i.P1.Systm,  i.P1.Matnr, i.P1.Maktx,  i.P1.Werks, i.P1.Stlal,  i.P1.Mtart,
    i.P1.Beskz,  i.P1.Sobsl, i.P1.Posnrd, i.P1.Posnr, i.P1.Postpd, i.P1.Postp,
    i.P1.Idnrkd, i.P1.Idnrk, i.P1.Cmaktd, i.P1.Cmakt, i.P1.Cmtard, i.P1.Cmtar,
    i.P1.Cbeskd, i.P1.Cbesk, i.P1.Csobsd, i.P1.Csobs, i.P1.Menged, smeng1,
    i.P1.Meinsd, i.P1.Meins, i.P1.Alposd, i.P1.Alpos, i.P1.Alpgrd, i.P1.Alpgr,
    i.P1.Alprfd, i.P1.Alprf, i.P1.Alpstd, i.P1.Alpst, i.P1.Ewahrd, sewah1,
    i.P1.Sankod, i.P1.Sanko, i.P1.Sanfed, i.P1.Sanfe, i.P1.Sankad, i.P1.Sanka,
    i.P1.Dokard, i.P1.Dokar, i.P1.Doknrd, i.P1.Doknr, i.P1.Dokvrd, i.P1.Dokvr,
    i.P1.Doktld, i.P1.Doktl,
    i.P2.Systm,  i.P2.Matnr, i.P2.Maktx,  i.P2.Werks, i.P2.Stlal,  i.P2.Mtart,
    i.P2.Beskz,  i.P2.Sobsl, i.P2.Posnrd, i.P2.Posnr, i.P2.Postpd, i.P2.Postp,
    i.P2.Idnrkd, i.P2.Idnrk, i.P2.Cmaktd, i.P2.Cmakt, i.P2.Cmtard, i.P2.Cmtar,
    i.P2.Cbeskd, i.P2.Cbesk, i.P2.Csobsd, i.P2.Csobs, i.P2.Menged, smeng2,
    i.P2.Meinsd, i.P2.Meins, i.P2.Alposd, i.P2.Alpos, i.P2.Alpgrd, i.P2.Alpgr,
    i.P2.Alprfd, i.P2.Alprf, i.P2.Alpstd, i.P2.Alpst, i.P2.Ewahrd, sewah2,
    i.P2.Sankod, i.P2.Sanko, i.P2.Sanfed, i.P2.Sanfe, i.P2.Sankad, i.P2.Sanka,
    i.P2.Dokard, i.P2.Dokar, i.P2.Doknrd, i.P2.Doknr, i.P2.Dokvrd, i.P2.Dokvr,
    i.P2.Doktld, i.P2.Doktl,
